...
This is a first level of testing. It works well if you have little code/few features in your application.
...
It is one of the limitation of writing test code, sometimes the test code is wrong or incomplete. But as we will see, it's always better than no tests at all.
...
3. REFACTOR: refactore your code, test should pass
...
# - test pass
# - in most cases, that is here that refactoring would take place
```
